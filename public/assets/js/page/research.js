...
class Research12345 extends Page12345 {
	constructor(_pagelayer) {
		...
		this.researchThree = new PointThree(this.pagelayer.singleRenderer, "research", true)
		this.researchThree.animate()
		this.researchThree.render()
	}
	...
	loadList(_data) {
		...
		this.list.load(this.list_data, this.researchThree)
	}
